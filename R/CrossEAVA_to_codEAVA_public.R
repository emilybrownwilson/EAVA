...
################################## CrossEAVA maps WHO 2016 VA Questionnaire variables into format required for EAVA cause assignment & hierarchy

file <- getwd()
file
odk <- read.csv(file.path(file,"Data/Comsa_WHO_VA_20240412.csv"), stringsAsFactors = FALSE)
COMSAdata <- odk
names(COMSAdata) <- tolower(colnames(COMSAdata))
COMSAvariables <- as.vector(colnames(COMSAdata))
dim(COMSAdata)

table(COMSAdata$agegpdeath) # SB-NN: 1190
# Remove Stillbirths
...
COMSAdata$id10022 <- COMSAdata$ageindaysnew

COMSAdata$i022a <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew  >= 65*365.25, "y", "n"))
COMSAdata$i022b <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew >= 50*365.25 & COMSAdata$ageindaysnew < 65*365.25, "y","n"))
COMSAdata$i022c <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew >= 15*365.25 & COMSAdata$ageindaysnew < 50*365.25, "y", "n"))
COMSAdata$i022d <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew >= 5*365.25 & COMSAdata$ageindaysnew < 15*365.25, "y", "n"))
COMSAdata$i022e <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew >= 1*365.25 & COMSAdata$ageindaysnew < 5*365.25, "y", "n"))
COMSAdata$i022f <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew >= 28 & COMSAdata$ageindaysnew < 365.25, "y", "n"))
COMSAdata$i022g <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew < 28, "y", "n"))
COMSAdata$i022h <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew < 1, "y", "n"))
COMSAdata$i022i <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew %in% c(1:2), "y", "n"))
COMSAdata$i022j <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew %in% c(3:7), "y", "n"))
COMSAdata$i022k <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$ageindaysnew %in% c(8:27), "y", "n"))
COMSAdata$i022l <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$id10019b == "y" & COMSAdata$ageindaysnew >= 12*365.25 & COMSAdata$ageindaysnew < 20*365.25, "y", "n"))
COMSAdata$i022m <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$id10019b == "y" & COMSAdata$ageindaysnew >= 20*365.25 & COMSAdata$ageindaysnew < 35*365.25, "y", "n"))
COMSAdata$i022n <- ifelse(is.na(COMSAdata$ageindaysnew),".", ifelse(COMSAdata$id10019b == "y" & COMSAdata$ageindaysnew >= 35*365.25 & COMSAdata$ageindaysnew < 49*365.25, "y", "n"))

table(COMSAdata$i022a, exclude=NULL)
table(COMSAdata$i022b, exclude=NULL)
table(COMSAdata$i022c, exclude=NULL)
table(COMSAdata$i022d, exclude=NULL)
table(COMSAdata$i022e, exclude=NULL)
table(COMSAdata$i022f, exclude=NULL)
table(COMSAdata$i022g, exclude=NULL)
table(COMSAdata$i022h, exclude=NULL)
table(COMSAdata$i022i, exclude=NULL)
table(COMSAdata$i022j, exclude=NULL)
table(COMSAdata$i022k, exclude=NULL)
table(COMSAdata$i022l, exclude=NULL)
table(COMSAdata$i022m, exclude=NULL)
table(COMSAdata$i022n, exclude=NULL)
...
output <- odk2EAVA(COMSAdata,id_col = "comsa_id")
...
################################## codEAVA gets EAVA causes from odk2EAVA output
...
write.csv(EAVA_neonate, file=file.path(file,"/Data/cod_eava_neonate_comsa_public.csv"), row.names=FALSE)
write.csv(EAVA_child, file=file.path(file,"/Data/cod_eava_child_comsa_public.csv"), row.names=FALSE)
