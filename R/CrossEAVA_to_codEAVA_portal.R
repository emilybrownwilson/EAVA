...
file <- getwd()
file
odk <- read.csv(file.path(file,"Data/all_WHO.csv"), stringsAsFactors = FALSE)
...
output <- odk2EAVA(odk,id_col = "deathid")
...
write.csv(EAVA_neonate, file=file.path(file,"/Data/cod_eava_neonate_comsa.csv"), row.names=FALSE)
write.csv(EAVA_child, file=file.path(file,"/Data/cod_eava_child_comsa.csv"), row.names=FALSE)
