...
## Example
Taken together, data are first converted from the WHO 2016 Verbal Autopsy Questionnaire format using odk2EAVA() and then that output file is used to generate causes of death based on the reformatted signs and symptoms and a validated hieararchy of causes.
